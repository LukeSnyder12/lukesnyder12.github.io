...
async function init() {
  ...
  var tracerObj = new RayTracingSphereObject(tracer._device, tracer._canvasFormat, camera);
  // var sphereObj = new RayTracingSphereObject(tracer._device, tracer._canvasFormat, camera);
  await tracer.setTracerObject(tracerObj);
  // await tracer.setTracerObject(sphereObj);
